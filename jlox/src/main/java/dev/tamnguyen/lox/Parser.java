...
public class Parser {
    ...
    private Stmt returnStatement() {
        ...
        consume(TokenType.SEMICOLON, "Exepct ';' after return value.");
    ...
    private Expr expression(boolean ignoreCommaRule) {
        return ignoreCommaRule ? assignment() : comma();
    }
    ...
    private void synchronize() {
        ...
        while (!isAtEnd()) {
            if (previous().getType().equals(TokenType.SEMICOLON)) {
                return;
            }
